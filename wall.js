class Wall2D {
    ...
    constructor(position, rotationX, rotationY, rotationZ) {
      this.vertexPositions = Wall2D.vertexPositions;
      for (let i = 0; i < 0; i ++) {
        this.vertexPositions = this.subdivide(this.vertexPositions);
      }
      this.texture = this.loadTexture(gl, './textures/brks.jpg');
    ...
    draw(vMat) {
      ...
      mMat = mult(mMat, rotateX(this.rotationX));
      mMat = mult(mMat, rotateY(this.rotationY));
      mMat = mult(mMat, rotateZ(this.rotationZ));
